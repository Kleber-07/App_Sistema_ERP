    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                <Image style={styles.imgperBack} source={{ uri: 'https://m.media-amazon.com/images/I/71ROhAkb8vL._AC_UF1000,1000_QL80_.jpg' }} /> 
            ...
            <View style={{ width: '100%', alignItems: 'center' }}>
                ...
                <View style={styles.desc}>
                    ...
                    <Text style={styles.descInfo}>
                        O Xbox Series S é o novo console da Microsoft com lançamento marcado para 10 de novembro de 2020. O videogame chega pelo preço de US$ 299 (cerca de R$ 1.580, em conversão direta e sem impostos) e pode ser considerado uma versão mais barata e simples do Xbox Series X.
                    </Text>
